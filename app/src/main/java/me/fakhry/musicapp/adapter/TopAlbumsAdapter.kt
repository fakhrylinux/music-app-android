package me.fakhry.musicapp.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.bumptech.glide.Glide
import me.fakhry.musicapp.databinding.ItemAlbumBinding
...
class TopAlbumsAdapter : RecyclerView.Adapter<TopAlbumsAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: ItemAlbumBinding) :
        ...
        fun bindItem(album: Album, listener: ((Album) -> Unit)?) {
            Glide.with(itemView).load(album.imageAlbum).placeholder(android.R.color.darker_gray)
